<template>
  ...
  <div class="banner">
    <img class="banner__img" src="http://www.dell-lee.com/imgs/vue3/banner.jpg" alt="banner">
  </div>
  <div class="icons">
    <div
      ...
      class="icons__item"
    >
      <img :src="iconItem.imgUrl" :alt="iconItem.desc" class="icons__item__img">
      <p class="icons__item__desc">{{ iconItem.desc }}</p>
    </div>
  </div>
  <div class="gap"></div>
</template>
...
.search {
  ...
  .iconfont {
    ...
    padding: .08rem .12rem .08rem .16rem;
    font-size: .16rem;
  }
  &__text {
    display: inline-block;
